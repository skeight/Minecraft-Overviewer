            ...
            for(i=0; i < PyList_Size(data_array); i++) {
                ...
                if(PyDict_Check(data_dict)) {
                    ...
                    if(calcx == PyInt_AsLong(PyDict_GetItemString(data_dict,"x")) && calcy == PyInt_AsLong(PyDict_GetItemString(data_dict,"y")) && calcz == PyInt_AsLong(PyDict_GetItemString(data_dict,"z")) ) {
						...
						if(state->block == 768) {
							ret = PyInt_AsLong(PyDict_GetItemString(data_dict,"color"));
							ret = (ret << 1) | PyInt_AsLong(PyDict_GetItemString(data_dict,"style"));
							/* rot and style */
						} else if(state->block == 2050) {
							if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_router") == 0) {
								ret = 1;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_maker") == 0) {
								ret = 2;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_stamper") == 0) {
								ret = 3;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_barrel") == 0) {
								ret = 5;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_packager") == 0) {
								ret = 8;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_slag") == 0) {
								ret = 11;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_solarturbine") == 0) {
								ret = 13;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_solder") == 0) {
								ret = 9;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_heater") == 0) {
								ret = 15;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_grinder") == 0) {
								ret = 17;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_mixer") == 0) {
								ret = 18;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_crystal") == 0) {
								ret = 19;
							} else if(strcmp(PyString_AsString(PyDict_GetItemString(data_dict,"id")),"factory_greenware") == 0) {
								ret = 20;
							} else {
								ret = 0;
							}
